...
<section class="section">
	<div class="container">
		<h1 class="heading-2 text-center mb-8 text-primary">Contact Us</h1>
		<div class="container-narrow">
			<div class="card mb-6">
				<p class="text-lead text-muted mb-0">
			...
			<form onsubmit={handleSubmit} class="card">
				<div class="flex-col flex-gap-lg">
					<div>
						...
						<input type="text" id="name" name="name" required class="input" placeholder="Your Name" />
					</div>
					...
					<div>
						...
						<textarea id="message" name="message" required rows="5" class="textarea" placeholder="Your Message"
						></textarea>
					</div>
