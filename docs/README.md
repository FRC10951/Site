...
- **[DEVELOPMENT.md](./DEVELOPMENT.md)** - How to set up and develop
- **[TECHNICAL.md](./TECHNICAL.md)** - Architecture and tech stack
...
For detailed responsive design patterns, see **[BREAKPOINTS.md](./BREAKPOINTS.md)**.

### For Development

Start with **[DEVELOPMENT.md](./DEVELOPMENT.md)** for setup, then refer to:
